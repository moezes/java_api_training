...
class RequestHandlerTest {
    ...
    void correct_start_request() {
        Server s = null;
        try {
            s = ServerTest.StartTestServer("9879");
        } catch (Exception e) {
            e.printStackTrace();
    ...
    void bad_start_request() {
        Server s = null;
        try {
            s = ServerTest.StartTestServer("9880");
        } catch (Exception e) {
            e.printStackTrace();
            Assertions.assertEquals(0, 1, "Number of exception on server");
        }
    ...
    void no_more_ships_to_shoot() throws IOException {
        Server s = null;
        try {
            s = ServerTest.StartTestServer("9899");
        ...
        final int[] loc = s.game.game_board.get(4).get(0);
        final int[] coord2 = s.game.game_board.get(4).get(1);
        exchange = new HttpsExchange() {
            @Override
            public SSLSession getSSLSession() {
                return null;
